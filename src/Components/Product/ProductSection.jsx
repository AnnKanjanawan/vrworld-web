    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <div className="mb-14 text-center">
          {/* <span className="inline-flex rounded-full border border-[#7F8B72]/20 bg-white/90 px-4 py-2 text-sm font-medium tracking-[0.15em] text-[#7F8B72] shadow-sm backdrop-blur-sm">
            OUR COLLECTION
          </span> */}

          <h2 className="mt-5 text-4xl font-semibold tracking-tight text-[#111111] sm:text-5xl md:text-6xl">
            สินค้าสำหรับโรงแรม
          </h2>

          <p className="mx-auto mt-4 max-w-2xl text-base leading-8 text-[#666666] sm:text-lg">
            คัดสรรสินค้าคุณภาพสำหรับห้องพัก โรงแรม และรีสอร์ท
            เพื่อยกระดับประสบการณ์การเข้าพักให้ดูพรีเมียมและน่าประทับใจ
          </p>

          <div className="mx-auto mt-6 h-[3px] w-24 rounded-full bg-[#7F8B72]" />
        </div>
